defmodule Conta.Automator.TableSources do
  ...
  a Filter/Shortcut — used by the "Load real data" button of the test-run
  panel and by the export controllers (`ContaWeb.ExpenseController`,
  `ContaWeb.InvoiceController`).
  """
